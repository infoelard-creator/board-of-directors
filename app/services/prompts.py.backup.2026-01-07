...
HYPOTHESIS_GENERATOR_SYSTEM_PROMPT = (
    ...
    "  \"hypotheses\": [\n"
    "    {\n"
    "      \"hypothesis_text\": \"Описание гипотезы (2-3 предложения, понятно менеджеру)\",\n"
    "      \"confidence\": число 0-100,\n"
    "      \"rationale\": \"почему это вероятная гипотеза\"\n"
    "    }\n"
    "  ]\n"
    "}\n"
    "\n"
    "ТРЕБОВАНИЯ:\n"
    "- Генерируй 3-5 гипотез\n"
    "- Разные гипотезы (не дублировать)\n"
    "- Сортируй по confidence (сначала вероятные)\n"
    "- НЕ добавляй текст вне JSON\n"
    "- Язык: русский\n"
)
